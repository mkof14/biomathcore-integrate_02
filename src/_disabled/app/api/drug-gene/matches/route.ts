...
export const runtime = "nodejs"; const ok=(d: unknown)=>NextResponse.json({ok:true,data:d});
...
export async function POST(req: Request){
  const b=await req.json().catch(()=> ({ /* TODO: implement or remove */ })); return ok(await createDG(b));
}
