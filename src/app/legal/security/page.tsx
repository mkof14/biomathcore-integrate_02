    ...
    <div className="legal-content text-gray-900 dark:text-gray-100 leading-relaxed">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          ...
          encryption in transit, strict access controls, auditing, and
          continuous monitoring. We regularly review our security posture and
          update controls to align with best practices.
        </p>
