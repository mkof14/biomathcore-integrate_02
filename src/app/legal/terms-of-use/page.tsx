  ...
  return (
    <div className="legal-content text-gray-900 dark:text-gray-100 leading-relaxed">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          When you create an account with us, you represent that you are at
        ...
        <p className="text-sm text-gray-900 mt-8">
          This is a demo page. The full Terms of Service will be available in
          the actual version of the site.
        </p>
      </div>
    </div>
  );
