  ...
  return (
    <div className="legal-content text-gray-900 dark:text-gray-100 leading-relaxed">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          Recurring charges are processed by our payment provider. You may
          cancel according to your plan terms.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Disclaimers</h2>
        <p className="mb-4">
          Services are provided “as is” without warranties. To the extent
          permitted by law, our liability is limited.
        </p>
        ...
        <LegalNote>
          Note: These Terms summarize key rules for service use. Specific
          product terms may apply to certain features.
        </LegalNote>
      </div>
    </div>
  );
