  ...
  return (
    <div className="legal-content text-gray-900 dark:text-gray-100 leading-relaxed">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          At BioMath Core (“we”, “us”, or “our”), we take your privacy
        ...
        <p className="mb-4">
          ...
          used, including IP address, browser type and version, pages visited,
          time and date of visits, time spent on pages, unique device
