    ...
    <div className="legal-content text-gray-900 dark:text-gray-100 leading-relaxed">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          ...
          protect personal information when you use the BioMath Core platform.
        </p>
        ...
        <ul className="list-disc ml-6 space-y-1">
          ...
          <li>
            Payment data: limited billing details processed via our payment
            provider.
          </li>
        ...
        <p className="mb-4">
          We share data with service providers under contract (e.g., hosting,
          analytics, payments). We do not sell personal data. We disclose
          information when required by law or to protect users and services.
        </p>
        ...
        <p className="mb-4">
          We retain data for as long as necessary for the purposes described or
          as required by law. We may anonymize data for analytics.
        </p>
        ...
        <LegalNote>
          Note: This summary is provided for transparency and may be updated.
          For specific regional notices see GDPR and Data Protection sections.
        </LegalNote>
      </div>
    </div>
  );
