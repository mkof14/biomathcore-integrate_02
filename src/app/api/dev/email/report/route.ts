...
export async function GET() {
  ...
  <title>Report Ready — BioMath Core</title>
  <style>
  ...
  <div class="wrap">
    ...
    <div class="body">
      ...
      <p>The new report is now available in your account. Click the button below to view it.</p>
      <a class="btn" href="${BTN}" target="_blank" rel="noopener">View Report</a>
      <p>You can also find all previous reports in Member → Reports.</p>
    </div>
