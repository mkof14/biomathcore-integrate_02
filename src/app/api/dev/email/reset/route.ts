...
export async function GET() {
  ...
  const BTN = `${SITE}/auth/reset-password?token=dummytoken`;

  const html = `<!doctype html><html><head><meta charset="utf-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1"/>
  <title>Reset Password — BioMath Core</title>
  <style>
  ...
  <div class="wrap">
    ...
    <div class="body">
      <h2>Reset your BioMath Core password</h2>
      <p>Click the button below to create a new password.</p>
      <a class="btn" href="${BTN}" target="_blank" rel="noopener">Reset Password</a>
    </div>
