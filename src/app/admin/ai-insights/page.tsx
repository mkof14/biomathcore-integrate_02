...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-6">
      <SectionHeader
        title="AI Insights"
        desc="Automated analysis and recommendations."
      />
      ...
      <div className="text-xs text-neutral-400">
        Notes: DAU — Daily Active Users; MAU — Monthly Active Users; MRR —
        Monthly Recurring Revenue; ARR — Annual Recurring Revenue.
      </div>
    </div>
  );
}
