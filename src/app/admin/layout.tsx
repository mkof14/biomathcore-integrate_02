    ...
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="px-3 py-1 rounded bg-slate-900/60 border border-slate-700 w-56"
        />
        <a
          href="/admin/alerts"
          className="px-3 py-1 rounded bg-rose-500 text-slate-900 font-semibold"
        >
          Incidents
        </a>
        <a
          href="/admin/monitoring"
          className="px-3 py-1 rounded bg-emerald-400 text-slate-900 font-semibold"
        >
          Status
        </a>
      </div>
