...
export default function Page() {
  ...
  const totalReq = (byDay ?? []).reduce(
    (a: number, b: any) => a + ((b.ai ?? 0) + (b.voice ?? 0) + (b.dg ?? 0)),
    0,
  );
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <div className="text-neutral-400">
          Snapshot of product, finance, and system health.
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <BigStat
          ...
          value={
            mtdRevenue != null
              ? mtdRevenue.toLocaleString(undefined, {
                  style: "currency",
                  currency: "USD",
                })
              : "—"
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-950/60 p-4">
          ...
          <div className="mt-2 text-sm text-neutral-300">
            If any card shows “—”, connect the underlying data source and
            refresh.
          </div>
        </div>
      </div>
