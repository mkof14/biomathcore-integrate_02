...
export function entitlementKey(key: string) {
  return `${ENTITLE_PREFIX}:${key}`;
}
...
export function getAllAnswers(): Record<string, Answers> {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    if (k.startsWith(STORAGE_PREFIX + ":")) {
      ...
      try {
        out[slug] = JSON.parse(localStorage.getItem(k) || "{}");
      } catch {}
    }
  }
  return out;
...
const SCHEMAS: Record<string, Question[]> = {
  patient: [
    ...
    },
    {
      ...
      type: "textarea",
      rows: 3,
      placeholder: "Drugs, foods, environmental…",
    },
    {
      id: "consent",
      label: "I consent to processing my wellness data.",
      type: "boolean",
      required: true,
    },
  ],
  ...
  "sexual-health-general": [
    ...
    {
      id: "protection",
      label: "Do you use protection consistently?",
      type: "boolean",
      required: true,
    },
    {
      id: "partners12m",
      label: "Number of partners (last 12 months)",
      type: "number",
      min: 0,
      max: 50,
      step: 1,
    ...
    {
      id: "nocturnalErectionsTrend",
      label: "Frequency of night/morning erections",
      type: "select",
      required: true,
      options: [
    ...
    {
      id: "stiHistory",
      label: "History of STIs (describe)",
      type: "textarea",
      rows: 4,
      placeholder: "If applicable, diagnosis and year…",
    },
    {
      id: "concerns",
      label: "Concerns or symptoms to discuss",
      type: "textarea",
      rows: 4,
      placeholder: "Pain, discharge, libido, etc.",
    },
  ],
  "sexual-health-male": [
    { id: "erectileIssues", label: "Erectile difficulties?", type: "boolean" },
    {
      id: "ejaculationIssues",
      label: "Ejaculation issues (premature/retrograde)?",
      type: "boolean",
    },
    ...
    {
      id: "nocturnalErectionsTrend_m",
      label: "Night/morning erections — trend",
      type: "select",
      options: [
        { value: "decrease", label: "Decreased" },
        { value: "same", label: "No change" },
  ...
  "sexual-health-female": [
    ...
    { id: "vaginalDischarge", label: "Unusual discharge?", type: "boolean" },
    {
      ...
      options: [
        ...
        { value: "ocp", label: "Oral contraceptive" },
        { value: "iud", label: "IUD" },
    ...
    {
      id: "hairPresenceChanges",
      label: "Changes in presence of hair (legs, arms, breast, back, face)",
      type: "boolean",
    },
    {
      id: "hairDensityChanges",
      label: "Changes in hair density (legs, arms)",
      type: "boolean",
    },
    { id: "notes", label: "Anything else to add", type: "textarea", rows: 4 },
  ],
