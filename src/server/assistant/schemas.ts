...
export function safeParseAssistantJSON(txt: string): AssistantJSON | null {
  try {
    ...
    if (
      (obj as any).citations != null &&
      !Array.isArray((obj as any).citations)
    )
      return null;
    if (Array.isArray((obj as any).citations)) {
      for (const c of (obj as any).citations) {
        ...
        if ((c as any).label != null && typeof (c as any).label !== "string")
          return null;
        if ((c as any).quote != null && typeof (c as any).quote !== "string")
          return null;
        if ((c as any).n != null && typeof (c as any).n !== "number")
          return null;
      }
    }
