...
export function Card(props: DivProps) {
  return (
    <div
      {...props}
      className={join(
        "rounded-xl border border-neutral-800 bg-neutral-950/50",
        props.className,
      )}
    />
  );
...
export function CardHeader(props: DivProps) {
  return (
    <div
      {...props}
      className={join("p-4 border-b border-neutral-800", props.className)}
    />
  );
}
...
export function CardFooter(props: DivProps) {
  return (
    <div
      {...props}
      className={join(
        "p-4 border-t border-neutral-800 flex items-center",
        props.className,
      )}
    />
  );
