  ...
  return (
    <footer className="bg-neutral-900 text-neutral-300 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-6 text-neutral-400">
              Advanced wellness management platform integrating analytics, AI,
              and connected services.
            </p>

            <div className="mt-4 flex gap-5">
              <a
                href="https://facebook.com/biomathcore"
                target="_blank"
              ...
              >
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="#FF0000">
                  <path d="M23.5 6.2a2.8 2.8 0 0 0-2-2C19.2 4 12 4 12 4s-7.2 0-9.5.2a2.8 2.8 0 0 0-2 2A29 29 0 0 0 .5 12a29 29 0 0 0 .1 5.8 2.8 2.8 0 0 0 2 2C4.8 20 12 20 12 20s7.2 0 9.5-.2a2.8 2.8 0 0 0 2-2 29 29 0 0 0 .1-5.8 29 29 0 0 0-.1-5.8zM9.8 15.5V8.5l6.4 3.5-6.4 3.5z" />
                </svg>
              </a>
              <a
                href="https://instagram.com/biomathcore"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="transition-opacity hover:opacity-80"
              >
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="#E4405F">
              ...
              <a
                href="https://linkedin.com/company/biomathcore"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="transition-opacity hover:opacity-80"
              >
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="#0A66C2">
                  <path d="M4.98 3.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM3 8.98h3.96V21H3V8.98zm7.03 0h3.8v1.63h.05c.53-1 1.83-2.05 3.76-2.05 4.02 0 4.76 2.65 4.76 6.1V21h-3.95v-5.61c0-1.34-.03-3.06-1.87-3.06-1.87 0-2.16 1.46-2.16 2.96V21h-3.95V8.98z" />
                </svg>
              </a>
              <a
                href="https://x.com/biomathcore"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="X"
                className="transition-opacity hover:opacity-80"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  className="relative after:absolute after:left-0 after:-bottom-0.5 after:h-px after:w-0 after:bg-sky-400 after:transition-all hover:after:w-full"
                  href="/"
                >
                  Home
                </Link>
      ...
      <div className="border-t border-white/10 py-6 text-center text-xs text-neutral-400">
        © {year} BioMath Core · Important Notice: BioMath Core is a wellness
        management platform, not a medical service. Always consult a qualified
