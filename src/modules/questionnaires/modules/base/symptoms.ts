...
export function baseSymptomsModule(): ModuleConfig {
  return { key:"base_symptoms", title:"Symptoms", description:"Current symptoms and duration.", questions:[
    { id:"sym.current", type:"textarea", label:"Current symptoms", placeholder:"e.g. chest discomfort on exertion; started ~2 months ago" },
    ...
    { id:"sym.triggers", type:"text", label:"Triggers", placeholder:"e.g. exercise, stress, meals" }
  ]};
}
