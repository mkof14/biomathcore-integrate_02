...
export function baseDemographicsModule(): ModuleConfig {
  return {
    ...
    questions: [
      ...
      {
        id: "base.consents.communication",
        type: "select",
      ...
      {
        id: "base.contact.email",
        type: "text",
        label: "Email",
        requiredIf: {
          when: "base.consents.communication",
          is: ["email", "both"],
        },
        ...
        validators: [
          {
            kind: "requireAnyFilled",
            fields: ["base.contact.email", "base.contact.phone"],
        ...
        validators: [
          {
            ...
            defaultMessage:
              "Use international format for your country (e.g. +1XXXXXXXXXX, +44XXXXXXXXXX)",
          },
          {
            kind: "requireAnyFilled",
            fields: ["base.contact.email", "base.contact.phone"],
