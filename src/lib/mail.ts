    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style={{ background: "#0b1220" }}>
      <tr>
        <td align="center" style={{ padding: "32px 16px" }}>
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style={{ maxWidth: "560px", background: "#0f172a", borderRadius: "16px", boxShadow: "0 6px 24px rgba(0,0,0,.35)", overflow: "hidden" }}>
            <tr>
              <td align="center" style={{ background: "#0b1220", padding: "28px 24px" }}>
                ...
                <div style={{ fontSize: "0", lineHeight: "0", height: "0", overflow: "hidden" }}>
            ...
            <tr>
              <td style={{ padding: "24px", color: "#93adc8", fontSize: "12px", borderTop: "1px solid rgba(255,255,255,.06)" }}>
          ...
          <div style={{ color: "#64748b", fontSize: "11px", marginTop: "16px", maxWidth: "560px" }}>
...
function btn(href: string, text: string) {
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" style={{ margin: "18px 0" }}>
    <tr>
      <td>
        <a href="${safeHref}"
           style={{ display: "inline-block", background: "#0ea5e9", color: "#fff", textDecoration: "none", padding: "12px 16px", borderRadius: "10px", fontWeight: "600" }}>
          ${text}
        </a>
      </td>
    </tr>
...
function sectionTitle(text: string) {
  return `<h2 style={{ color: "#e2e8f0", margin: "0 0 8px 0", fontSize: "18px", fontWeight: "700" }}>${text}</h2>`;
}
...
function renderResetPasswordHTML(link: string) {
  const body = `
    ...
    ${paragraph(`Link (for reference): <span style={{ wordBreak: "break-all", color: "#9bd2ff" }}>${link}</span>`, true)}
  `;
