...
type Ctx = {
  ...
  setLang: (l: Lang) => void;
  tUI: (k: string) => string;
  translateLabel: (k: string) => string;
};
const I18nCtx = createContext<Ctx | null>(null);

const UI_DICT: Record<string, Partial<Record<Lang, string>>> = {
  Back: { en: "Back", ru: "Назад" },
  "Patient Forms": { en: "Patient Forms", ru: "Анкеты пациентов" },
  "Save draft": { en: "Save draft", ru: "Сохранить черновик" },
  Submit: { en: "Submit", ru: "Отправить" },
  "Complete required": {
    en: "Complete required",
    ru: "Заполните обязательные",
  },
};
