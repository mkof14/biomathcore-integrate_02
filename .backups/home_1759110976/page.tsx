...
function CategoryCard({ c }: { c: CategoryUi }) {
  ...
  return (
    <Link
      ...
      className={
        "group relative flex items-start gap-4 rounded-2xl border p-5 sm:p-3 " +
        "bg-gradient-to-br " +
        c.tint +
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div
      ...
      role="listitem"
    >
      <div className="text-4xl sm:text-3xl font-extrabold text-white">
        {value}
      </div>
...
function HomePageView({ categories }: { categories: CategoryUi[] }) {
  return (
    <div className="relative">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-6xl px-4 sm:px-3 pt-10 sm:pt-14">
        <SectionTitle
      ...
      {/* Categories */}
      <section className="relative mx-auto max-w-6xl px-4 sm:px-3 mt-6">
      ...
      {/* Advantages */}
      <section className="relative mx-auto max-w-6xl px-4 sm:px-3 mt-12">
        <h2 className="text-lg sm:text-3xl font-extrabold mb-6 text-white">
          Our Advantages
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {ADVANTAGES.map((a) => (
            <div
              key={a.title}
              className={"rounded-2xl border bg-gradient-to-br p-5 sm:p-3 " + a.tint}
            >
      ...
      {/* CTA row */}
      <section className="relative mx-auto max-w-6xl px-4 sm:px-3 mt-12 mb-16">
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/services"
            className="inline-flex items-center justify-center rounded-xl px-3 py-3 bg-cyan-300 hover:bg-cyan-200 text-black font-semibold shadow-elev-1 transition"
          >
            Explore Services
          </Link>
          <AskAiButton />
